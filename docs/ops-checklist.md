...
- [ ] **스냅 보정범위 제한 (2026-07-16, @596)**: snap/마이리얼트립 세션에만 ①범위 안내 박스(포함: 피부·미백·잔머리·옷라인·색감 / 제외: 신체·하늘 합성, 의상 주름) ②허용범위 placeholder·예시 ③범위밖 키워드 입력 시 실시간 힌트 ④관리자 접수메일 "⚠️ 기본범위 확인" 배지 — 다른 상품군엔 흔적 없음
