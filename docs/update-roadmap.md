...
- **발견 — 사장님 결정 필요**: 8/17 확정 영업시간 "평일 09:30–13:00"(@791)이 예약 페이지엔 반영된 적 없다. `normalizeWeekdayBookingBlocks_`
  (7/13)가 평일 오전을 **11:30 에서 강제로 자른다**(`WEEKDAY_MORNING_END_MIN`) — 설정 시트에 13:00 을 넣어도 무시된다. 평일 11:30–13:00 예약 불가 상태.
