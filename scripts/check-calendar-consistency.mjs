...
const STRUCTURAL = [
  ...
  // 라벨은 main 의 이름 정리(processForm → processForm_)를 따르고,
  // 정규식은 메시지가 3개국어 객체(`throw new Error({ko:…,en:…,de:…}[_slotErrLang])`)로
  // 바뀐 걸 반영한다 — 가드 존재와 한국어 문구는 그대로 못박고 i18n 래퍼만 통과시킨다
