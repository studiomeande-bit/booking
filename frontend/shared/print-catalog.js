...
export const PRINT_CATALOG = [
  { id: 'basic_10x15',     cm: '10 × 15 cm',    additional: 5,  name: { ko: '기본 10×15cm',   en: 'Basic 10×15cm',           de: 'Basic 10×15cm' } },
  { id: 'premium_10x15',   cm: '10 × 15 cm',    additional: 8,  name: { ko: '프리미엄 10×15cm', en: 'Premium 10×15cm',         de: 'Premium 10×15cm' } },
  ...
  { id: 'basic_a4',        cm: '21 × 29.7 cm',  additional: 15, name: { ko: '기본 A4',        en: 'Basic A4',                de: 'Basic A4' } },
  { id: 'premium_a4',      cm: '21 × 29.7 cm',  additional: 20, name: { ko: '프리미엄 A4',     en: 'Premium A4',              de: 'Premium A4' } },
  { id: 'premium_a3',      cm: '29.7 × 42 cm',  additional: 50, name: { ko: '프리미엄 A3',     en: 'Premium A3',              de: 'Premium A3' } },
  { id: 'premium_a3plus',  cm: '32.9 × 48.3 cm', additional: 60, name: { ko: '프리미엄 A3+',   en: 'Premium A3+',             de: 'Premium A3+' } }
];
