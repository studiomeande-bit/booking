...
(function () {
  ...
  var T = {
    ko: {
      ...
      statement: '보내실 의사표시', statementDone: '의사표시', sending: '보내는 중…',
    ...
    en: {
      ...
      statement: 'Your statement', statementDone: 'Statement', sending: 'Sending…',
    ...
    de: {
      ...
      statement: 'Ihre Erklärung', statementDone: 'Erklärung', sending: 'Wird gesendet…',
  ...
  function done(name, contract, email, d) {
    ...
    var rows = [[t.statementDone, W ? W[lang].statement : ''], [t.name, name], [t.contract, contract], [t.email, email], [t.received, d.receivedAt + ' (Europe/Berlin)']];
    var list = $('doneList');
