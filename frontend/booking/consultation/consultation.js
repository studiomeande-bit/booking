...
const I18N = {
  de: {
    ...
    successText: 'Wir haben Ihnen eine Bestatigung per E-Mail gesendet. Studio mean pruft die Angaben und meldet sich mit Beratung, Angebot oder dem nachsten Schritt.',
  ...
  en: {
    ...
    successText: 'We have sent you a confirmation email. Studio mean will review the details and follow up with the consultation, quote, or next step.',
  ...
  ko: {
    ...
    successText: '확인 메일을 보내드렸습니다. Studio mean에서 내용을 검토한 뒤 상담 또는 견적 안내를 드리겠습니다.',
