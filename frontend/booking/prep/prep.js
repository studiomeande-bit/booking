  ...
  var Q = {
    prof: [
      { id: 'usage', kind: 'multi', t: { ko: '사진을 어디에 쓰시나요?', en: 'What will the photos be used for?', de: 'Wofür werden die Fotos verwendet?' }, c: [
        ...
        ['company', '회사 프로필', 'Company profile', 'Firmenprofil'],
      ...
      { id: 'mood', kind: 'single', star: true, t: { ko: '원하는 분위기', en: 'Preferred mood', de: 'Gewünschte Stimmung' }, c: [
        ['formal', '클래식 포멀 — 정장, 단색 배경', 'Classic formal — suit, plain background', 'Klassisch formell — Anzug, einfarbiger Hintergrund'],
        ['bizcasual', '비즈니스 캐주얼 — 밝고 친근하게', 'Business casual — bright and approachable', 'Business casual — hell und nahbar'],
        ['natural', '내추럴 — 자연광 느낌, 부드러운 톤', 'Natural — soft daylight feel', 'Natürlich — weiches Tageslicht'],
        ['creative', '크리에이티브 — 음영과 무드', 'Creative — shadow and mood', 'Kreativ — Schatten und Stimmung']
      ] },
      { id: 'background', kind: 'single', star: true, t: { ko: '배경 톤', en: 'Background tone', de: 'Hintergrundton' }, c: [
        ['white', '화이트', 'White', 'Weiß'],
        ['grey', '그레이', 'Grey', 'Grau'],
        ['beige', '베이지 · 웜', 'Beige / warm', 'Beige / warm'],
        ['dark', '다크', 'Dark', 'Dunkel']
      ] },
      { id: 'expression', kind: 'single', t: { ko: '표정 방향', en: 'Expression', de: 'Gesichtsausdruck' }, c: [
        ['smile', '미소 (치아 보임)', 'Smile (teeth)', 'Lächeln (mit Zähnen)'],
        ['soft', '옅은 미소', 'Soft smile', 'Leichtes Lächeln'],
      ...
      { id: 'retouch', kind: 'multi', t: { ko: '보정에서 꼭 지켜줬으면 하는 것', en: 'Retouching preferences', de: 'Wünsche zur Retusche' }, c: [
    ...
    stud: [
      { id: 'mood', kind: 'single', star: true, t: { ko: '원하는 분위기', en: 'Preferred mood', de: 'Gewünschte Stimmung' }, c: [
        ['bright', '밝고 화사하게', 'Bright and airy', 'Hell und luftig'],
        ['warm', '따뜻한 톤 — 베이지 · 크림', 'Warm tones — beige / cream', 'Warme Töne — Beige / Creme'],
        ['calm', '차분한 무드 — 딥톤 · 음영', 'Calm mood — deep tones', 'Ruhige Stimmung — dunkle Töne'],
        ['minimal', '심플 미니멀', 'Simple minimal', 'Schlicht minimal']
      ] },
      { id: 'background', kind: 'single', star: true, t: { ko: '배경 톤', en: 'Background tone', de: 'Hintergrundton' }, c: [
        ['white', '화이트', 'White', 'Weiß'],
        ['grey', '그레이', 'Grey', 'Grau'],
        ['beige', '베이지 · 웜', 'Beige / warm', 'Beige / warm'],
        ['sky', '스카이', 'Sky blue', 'Himmelblau']
      ] },
      ...
      { id: 'props', kind: 'multi', t: { ko: '소품 · 의상 (백일 · 돌 촬영이면)', en: 'Props / outfits (for 100-day or 1st birthday)', de: 'Requisiten / Outfits (100-Tage / 1. Geburtstag)' }, c: [
    ...
    wed: [
      ...
      { id: 'mood', kind: 'single', star: true, t: { ko: '전체 무드', en: 'Overall mood', de: 'Gesamtstimmung' }, c: [
        ['romantic', '클래식 로맨틱', 'Classic romantic', 'Klassisch romantisch'],
        ['film', '필름 감성 — 그레인 · 웜', 'Film look — grain, warm', 'Filmlook — Korn, warm'],
        ['cinematic', '시네마틱 — 대비 · 딥톤', 'Cinematic — contrast, deep tones', 'Cinematic — Kontrast, dunkle Töne'],
        ['candid', '밝고 캔디드 — 자연스러운 순간', 'Bright and candid', 'Hell und ungestellt']
      ] },
      { id: 'colorTone', kind: 'single', star: true, t: { ko: '색감 방향', en: 'Colour direction', de: 'Farbrichtung' }, c: [
        ['warm', '웜톤', 'Warm', 'Warm'],
        ['neutral', '뉴트럴 — 실제 색에 충실', 'Neutral — true to life', 'Neutral — naturgetreu'],
        ['muted', '무디 · 저채도', 'Muted / desaturated', 'Gedämpft / entsättigt']
      ] },
      { id: 'posed', kind: 'single', t: { ko: '연출 비율', en: 'Posed vs candid', de: 'Gestellt oder ungestellt' }, c: [
        ['posed', '포즈 연출 위주', 'Mostly posed', 'Überwiegend gestellt'],
        ['balanced', '반반', 'A balance of both', 'Ausgewogen'],
        ['candid', '자연스러운 스냅 위주', 'Mostly candid', 'Überwiegend ungestellt']
      ] },
