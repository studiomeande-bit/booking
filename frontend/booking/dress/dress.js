...
(function () {
  ...
  function renderProps() {
    document.getElementById('propsSec').innerHTML =
      ...
      '<ul class="proplist">' + ['prop_veil','prop_clip','prop_bouquet','prop_bout'].map(function(k){return '<li>'+esc(t(k))+'</li>';}).join('') + '</ul>' +
